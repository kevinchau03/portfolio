                ...
                <Link href="/passion/careers" className="hover:bg-card p-2 rounded-lg">
                    <div className="flex flex-col gap-4 w-1/2">
                        <div>
                            ...
                            <p className="text-muted text-sm">Read through as I give insight on what its like to study for a software engineering job in today's age.</p>
                        </div>
                ...
                <Link href="/passion/family" className="hover:bg-card p-2 rounded-lg">
                    <div className="flex flex-col gap-4 w-1/2">
                        <div>
                            ...
                            <p className="text-muted text-sm">I explore my past and all the things that lead me to where I am today</p>
                        </div>
                        <div className="inline-flex items-center text-accent">
                            Read Article
                            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"
